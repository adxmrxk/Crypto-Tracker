...
const AccountSecurityPage = () => {
  ...
  return ( 
      ...
      <div className='rounded-md w-[100%] h-auto relative top-4 p-3'>
            ...
            <div>
              <div className='flex justify-between items-center m-5 mt-8'>
                <h2 className='font-roboto font-normal text-left ml-25 w-[380px]'>Recent Logins</h2>
              ...
              <p className='font-roboto text-sm w-fit ml-30 -mt-6'>View your recent login devices and locations.</p>
            </div>

            {/* Login Alerts */}          
            <div className='mb-10'>
              <div className='flex justify-between items-center m-5 mt-8'>
                <h2 className='font-roboto font-normal text-left ml-25 w-[380px]'>Login Alerts</h2>
                  <div className='pr-24'>
                      <ControlledSwitches></ControlledSwitches>
                    </div>
                </div>
              <p className='font-roboto text-sm w-fit ml-30 -mt-6'>Get notified when a login occurs from an unrecognized device or location.</p>
            </div>
            ...
            <div className='mb-10'>
              <div className='flex justify-between items-center m-5 mt-8'>
                <h2 className='font-roboto font-normal text-left ml-25 w-[380px]'>Direct Messages</h2>
                  <div className='pr-24'>
                      <ControlledSwitches></ControlledSwitches>
                  </div>
                </div>
            ...
            <div>
              <div className='flex justify-between items-center m-5 mt-10 mb-10' onClick={ () => console.log('Gender Changed')}>
                <h2 className='font-roboto font-normal w-fit ml-25'>Blocked Accounts</h2>
                <div className='flex items-center gap-[8px] mr-22 cursor-pointer group'>
