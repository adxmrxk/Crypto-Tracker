      ...
      <div className={`relative z-10 flex-1 ${signUpClicked ? "blur-xs" : ""}`}>
        <div data-aos="fade-up">
          <div className="relative rounded-lg flex justify-start items-center p-6 flex-1 mt-15">
            <div className=" flex flex-col justify-center flex-grow text-left">
              <h1 className="mb-10 text-7xl font-bold font-roboto bg-gradient-to-br from-blue-100 via-blue-200 to-blue-300  bg-clip-text text-transparent">
                Cryptoscope
              </h1>
              <Typography
                className="text-gray-200"
                variant="body1"
                sx={{ marginTop: "-1.5rem", fontFamily: '"Montserrat"' }}
              >
                Track your crypto portfolio, stay updated with the latest news,
                and simulate trades to see your investment potential unfold
                through history.
              </Typography>
              <SignInButton
        ...
        <div className="grid grid-cols-2 items-center mt-5">
          ...
          <div
            ...
            data-aos-offset="125"
          >
            <h1 className="text-3xl font-bold font-roboto bg-gradient-to-br from-orange-300 via-rose-500 to-purple-500 bg-clip-text text-transparent">
              Leverage Advanced Analytics to Track Your Cryptocurrencies
            </h1>
            <p className="mt-7 text-lg font-roboto w-[500px] text-gray-200">
              Gain real-time insights, identify trends, and make smarter
