...
import { DeFiTokensList } from '../../utils/coinCatagories'
...
const DeFiTokens = () => {
  ...
  DeFiCoins = DeFiTokensList.map((coin, index) => {
    return DeFiTokensList[index].id;
  })  

  const {data, loading, error } = useCryptoServers(DeFiCoins);
  console.log('DeFi Tokens', data);
  ...
  return (
        <div className=' h-[600px] overflow-hidden'>
          <div className='flex flex-row justify-between items-center mx-auto mb-2'>
            <h1 className='font-roboto text-2xl font-semibold text-left ml-12 text-gray-300'>DeFi Tokens</h1>
